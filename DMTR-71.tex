...
~Effectively, this run ended up being a 100LV + 20HV test; similar to
LVV-T1089 only with more LV queries.
 &
    \\\hline
...
\item
  0 Object-Source joins (see comment section) --- Baseline: 8~
\item
  0 Object-ForcedSource joins (see comment section) --- Baseline: 4~
\item
...
\item
  Object-Source joins (not measured; see comment section) --- Baseline:
  under 12 hours
\item
  Object-ForcedSource joins (not measured; see comment section) ---
